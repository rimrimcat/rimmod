...
//    }
    ...
    // Server Constructor
    public ExampleMenu(int containerId, Inventory playerInv) {
        super(ModMenus.EXAMPLE_MENU.get(), containerId);
...
//        });
    ...
    public boolean stillValid(@NotNull Player pPlayer) {
        return stillValid(this.levelAccess, pPlayer, ModBlocks.EXAMPLE_MENU.get());
    }
