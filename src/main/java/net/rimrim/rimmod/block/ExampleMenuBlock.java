...
public class ExampleMenuBlock extends Block implements EntityBlock {
    ...
    public BlockEntity newBlockEntity(@NotNull BlockPos pos, @NotNull BlockState state) {
        return ModBlockEntities.EXAMPLE_MENU.get().create(pos, state);
    }
    ...
    //    @Override
//    public @NotNull InteractionResult useItemOn(@NotNull BlockState state, Level level, @NotNull BlockPos pos, @NotNull Player player, @NotNull InteractionHand hand, @NotNull BlockHitResult hitResult) {
//        BlockEntity be = level.getBlockEntity(pos);
//        if (!(be instanceof ExampleMenuBlockEntity blockEntity))
//            return InteractionResult.PASS;
//
